...
/** taskId별 로그 파일이 쌓이는 디렉터리 (`src/common/.log`). */
...
/**
 * LangChain 실행 한 싸이클을 통째로 `src/common/.log/<taskId>.log`에 남기는 콜백.
 *
...
export class FileLogCallback extends BaseCallbackHandler {
  ...
  override handleLLMStart(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleLLMStart']>>
  ) {
  ...
  override handleLLMError(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleLLMError']>>
  ) {
  ...
  override handleChatModelStart(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleChatModelStart']>>
  ) {
    this.record('LLM START', props);
  }
  ...
  override handleChainStart(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleChainStart']>>
  ) {
    this.record('CHAIN START', props);
  }

  override handleChainEnd(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleChainEnd']>>
  ) {
    this.record('CHAIN END', props);
  }

  override handleChainError(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleChainError']>>
  ) {
  ...
  override handleToolStart(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleToolStart']>>
  ) {
  ...
  override handleToolError(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleToolError']>>
  ) {
  ...
  override handleAgentAction(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleAgentAction']>>
  ) {
    this.record('AGENT ACTION', props);
  }

  override handleAgentEnd(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleAgentEnd']>>
  ) {
  ...
  override handleRetrieverStart(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleRetrieverStart']>>
  ) {
    this.record('RETRIEVER START', props);
  }

  override handleRetrieverEnd(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleRetrieverEnd']>>
  ) {
    this.record('RETRIEVER END', props);
  }

  override handleRetrieverError(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleRetrieverError']>>
  ) {
  ...
  override handleCustomEvent(
    ...props: Parameters<NonNullable<BaseCallbackHandler['handleCustomEvent']>>
  ) {
